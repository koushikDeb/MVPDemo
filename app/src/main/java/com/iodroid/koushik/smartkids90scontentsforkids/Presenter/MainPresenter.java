...
public class MainPresenter implements MainMVP_interface.presenter {
  ...
  private   MainMVP_interface.view view;
    ...
    public void createMovieslist(MultiSnapRecyclerView myrecyler) {
        view.populaterecycerView(myrecyler,getlist(5,"http://www.gstatic.com/tv/thumb/v22vodart/12863030/p12863030_v_v8_ae.jpg"));
    ...
    public void createshortcartoonslist(MultiSnapRecyclerView myrecyler) {
        ...
        view.populaterecycerView(myrecyler,getlist(15,"https://4.bp.blogspot.com/-BV2xlHZtk44/WQd1h5R037I/AAAAAAAAAFM/Refx0rt1C-MqOeum2nRtNuVZrn3RTmoxQCLcB/s1600/Shinchan%2BMovie%2BKaanta%2BLagaa%2BTC%2B2.jpg"));
    ...
    {
        view.populaterecycerView(myrecyler,getlist(10,"https://thumbs.mic..jpg"));
